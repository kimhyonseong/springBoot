...
-- 리스트 테스트
insert into item(code,description,state,name,price,quantity,member_idx) values ("A002","M사",10,"감자튀김1",9900,1000,2);
insert into item(code,description,state,name,price,quantity,member_idx) values ("A002","M사",10,"감자튀김2",9900,1000,2);
insert into item(code,description,state,name,price,quantity,member_idx) values ("A002","M사",10,"감자튀김3",9900,1000,2);
insert into item(code,description,state,name,price,quantity,member_idx) values ("A002","M사",10,"감자튀김4",9900,1000,2);
insert into item(code,description,state,name,price,quantity,member_idx) values ("A002","M사",10,"감자튀김5",9900,1000,2);
